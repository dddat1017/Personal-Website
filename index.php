    ...
    <body>
        ...
        <section class="portfolio" id="portfolioo">
            ...
            <div class="container">
                ...
                <button class="accordion">Handwritten Digits Recognition</button>
                <div class="panel">
                    <p>Project Insight: Convolutional neural network (CNN) model that recognizes handwritten digits from the MNIST Dataset. Tech stack: Python, Pytorch, Numpy, Matplotlib, etc. <a href="https://github.com/dddat1017/Handwritten-Number-Digits-Recognition" target="_blank"><strong><em>Learn more!</em></strong></a></li></h4></p>
                    <img src="images/Numbers.gif" alt="portfolio item" style="width:311px;height:200px;"/>
                </div>
                <button class="accordion">Wizard Top Down Shooter Game</button>
                <div class="panel">
                    <p>Project Insight: Simple Wizard Top Down Shooter Game to become familiarized with writing code for a game. Interesting, easy way to get started. Tech stack: Java, Java Swing, Object Oriented Programming, etc. <a href="https://github.com/dddat1017/Wiz4rdGame" target="_blank"><strong><em>Learn more!</em></strong></a></p>
        ...
        <section class="future">
            ...
            <ul>
                ...
                <li>Gaming (getting familiar with Unity)</li>
                <li>Blockchain</li>
