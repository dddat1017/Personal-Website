...
<html>
    ...
    <head>
		...
		<meta property="og:description" content="Self-learning & navigating the field of computer science through research, exploration, 
				and development"/>
		<meta property="og:url" content="datddo.com"/>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="home-about" id="about">
            <div class="container">
                ...
                <div class="home-about-textbox">
                    <p>Hi! My name is Dat. I'm an incoming student at the University of Washington - Paul G. Allen School of Computer 
					Science & Engineering starting in Fall 2019! The summer of 2018 I interned at the Port of Seattle where I worked on some 
					pretty cool Machine Learning projects. From facial recognition to natural language processing, the whole experience was one 
					to remember. This summer, I am heading to Microsoft as a High School Intern where I'll be working on the Developer 
					Experience Team! I look forward to learning and building more software as I'm eager to make an impact in this world 
					of technology. My goal is to spend a lot more time researching and developing the ideas and theories that interest 
					me, and share everything that I learn onto this site.</p>
                </div>
            </div>
        </section>
        ...
        <section class="portfolio" id="portfolioo">
            ...
            <div class="container">
                ...
                <div class="panel">
                    <p>Project Insight: Computer vision model that detects and recognizes real-life human faces. A neat implementation to this is that it collects and trains data almost instantaneously. Tech stack: Python, OpenCV, etc. <a href="https://github.com/dddat1017/Facial-Detection-Recognition" target="_blank">Learn more!</a></p>
                    <img src="images/Face.gif" width="50%" style="max-width:100%;"/>
                </div>
                <button class="accordion">Handwritten Digits Classification</button>
                <div class="panel">
                    <p>Project Insight: Convolutional neural network (CNN) model that recognizes handwritten digits from the MNIST Dataset. Tech stack: Python, Pytorch, Numpy, Matplotlib, etc. <a href="https://github.com/dddat1017/Handwritten-Digits-Classification" target="_blank">Learn more!</a></li></h4></p>
                ...
                <div class="panel">
                    <p>Project Insight: Simple Wizard Top Down Shooter Game to become familiarized with writing code for a game. Interesting, easy way to get started. Tech stack: Java, Java Swing, Object Oriented Programming, etc. <a href="https://github.com/dddat1017/Wizard-Top-Down-Shooting-Game" target="_blank">Learn more!</a></p>
                ...
                <div class="panel">
                    ...
                    <a href="https://www.academia.edu/36855782/The_Debates_on_the_Development_and_Research_of_AI_How_much_Limitation_if_any" target="_blank">View Publication</a></h4>
                </div>
            </div>
        </section>
